...
@section('content')
    <div class="container mx-auto mt-8 px-4">
        ...
        <div class="mb-6">
            <form method="GET" action="{{ route('tickets.index') }}" class="flex flex-col md:flex-row gap-4 items-center">

                {{-- بحث --}}
                <input type="text" name="search" placeholder="بحث برقم التذكرة أو العنوان"
                    value="{{ request('search') }}" class="border rounded px-3 py-2 w-full md:w-1/3">
                ...
                <select name="status" class="border rounded px-3 py-2">
                    ...
                    <option value="escalated" {{ request('status') == 'escalated' ? 'selected' : '' }}>مصعدة</option>
                </select>
